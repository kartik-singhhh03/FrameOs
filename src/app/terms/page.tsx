        ...
        <div className="glass-card rounded-2xl p-8 sm:p-10 space-y-10 text-[#1C1F1C]">
          ...
          <section>
            ...
            <p className="text-sm text-[#3A3D3A] leading-relaxed">
              Welcome to FrameOS (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or
              &ldquo;us&rdquo;). FrameOS is an online SaaS design editor
              available at{" "}
              <a
              ...
              that enables users to create Mac-style frames, social post
              templates, and aesthetic screenshots.
            </p>
            <p className="text-sm text-[#3A3D3A] leading-relaxed mt-3">
              By accessing or using FrameOS, you agree to be bound by these
              Terms &amp; Conditions (&ldquo;Terms&rdquo;). If you do not agree
          ...
          <section>
            ...
            <p className="text-sm text-[#3A3D3A] leading-relaxed">
              You must be at least 18 years of age to use FrameOS. By using our
              Service, you represent and warrant that you are 18 years or older
              and have the legal capacity to enter into a binding agreement. If
              you are using FrameOS on behalf of a company or organisation, you
          ...
          <section>
            ...
            <ul className="text-sm text-[#3A3D3A] leading-relaxed space-y-2 list-disc list-inside">
              <li>
                You may use the free editor without registration. Certain Pro
                features require a verified account.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="text-sm text-[#3A3D3A] leading-relaxed space-y-2 list-disc list-inside">
              <li>
                FrameOS offers a free plan with limited features and a{" "}
                <strong>Pro plan at $5 USD/month</strong>.
              </li>
              <li>
                ...
                , our Merchant of Record. Paddle handles all billing, tax
                compliance, and payment processing.
              </li>
              <li>
                Your Pro subscription{" "}
                <strong>automatically renews monthly</strong> on the same date
                you first subscribed, unless cancelled before the renewal date.
              </li>
              <li>
                All prices are displayed in USD and are exclusive of applicable
                taxes where required by law.
              </li>
              <li>
                We reserve the right to change pricing with at least 30
                days&rsquo; notice to active subscribers.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="text-sm text-[#3A3D3A] leading-relaxed space-y-2 list-disc list-inside">
              <li>
                ...
                <strong>at any time</strong> from your account settings or by
                contacting us. Cancellation takes effect at the end of the
                current billing period.
              </li>
              <li>
                Upon cancellation, you will retain Pro access until your billing
                period ends, after which your account will revert to the free
                plan.
              </li>
              <li>
                FrameOS is a <strong>digital product</strong>. As such, refunds
                are generally not provided for partially used billing periods.
          ...
          <section>
            ...
            <ul className="text-sm text-[#3A3D3A] leading-relaxed space-y-2 list-disc list-inside">
              ...
              <li>
                Create, distribute, or publish harmful, hateful, defamatory, or
                illegal content.
              </li>
              <li>
                Infringe upon any third party&rsquo;s intellectual property,
              ...
              <li>
                Use automated tools, bots, or scrapers to access or abuse our
                service.
              </li>
              <li>
                Attempt to gain unauthorised access to any systems or networks
                connected to FrameOS.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="text-sm text-[#3A3D3A] leading-relaxed space-y-2 list-disc list-inside">
              <li>
                FrameOS and all its content, features, design, code, and
                trademarks are the exclusive property of FrameOS and its
                creators.
              </li>
              <li>
                You retain full ownership of the designs and content you create
                using FrameOS. By using our Service, you grant us no rights over
                your created content.
              </li>
              <li>
                You may not use our name, logo, or brand identity without
                explicit written permission.
              </li>
              <li>
                Any feedback or suggestions you provide to us may be used by
                FrameOS without obligation or compensation to you.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-[#3A3D3A] leading-relaxed">
              FrameOS is provided on an &ldquo;as is&rdquo; and &ldquo;as
          ...
          <section>
            ...
            <p className="text-sm text-[#3A3D3A] leading-relaxed">
              ...
              with an updated &ldquo;Last updated&rdquo; date. We will make
              reasonable efforts to notify active subscribers of material
              changes via email or in-app notification. Your continued use of
              FrameOS after any changes constitutes your acceptance of the new
              Terms.
            </p>
          </section>
